...
void Player::SendLevelupInfo(uint32 level, uint32 Hp, uint32 Mana, uint32 Stat0, uint32 Stat1, uint32 Stat2, uint32 Stat3, uint32 Stat4)
{
	...
	packet.power[ POWER_TYPE_MANA ] = Mana;	//only mana gain is increased others are fixed => morron blizz ?
...
void Player::SendLogXPGain(uint64 guid, uint32 NormalXP, uint32 RestedXP, bool type)
{
    ...
    {
/*
{SERVER} Packet: (0x7656) SMSG_LOG_XPGAIN PacketSize = 22 TimeStamp = 19782081
09 B2 33 00 28 00 30 F5 
4B 00 00 00 xp
00 false
4B 00 00 00 rested
00 00 80 3F
...
*/
    ...
    {
/*
{SERVER} Packet: (0x7656) SMSG_LOG_XPGAIN PacketSize = 14 TimeStamp = 19968595
