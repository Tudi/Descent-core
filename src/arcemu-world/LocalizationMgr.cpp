...
#define SAFE_FREE_PTR(x) if(deletedPointers.find((x)) == deletedPointers.end()) { deletedPointers.insert((x)); free((x)); }
	...
	m_CreatureNames = NULL;
	delete [] m_GameObjectNames;
	m_GameObjectNames = NULL;
	delete [] m_Items;
	m_Items = NULL;
	delete [] m_NpcTexts;
	m_NpcTexts = NULL;
	...
	/************************************************************************/
	{
		...
		if(result)
		{
			do 
			{
				...
				cn.Name = strdup_local(f[2].GetString());
				cn.SubName = strdup_local(f[3].GetString());
	...
	/************************************************************************/
	{
		...
		if(result)
		{
			do 
			{
				...
				gn.Name = strdup_local(f[2].GetString());
	...
	/************************************************************************/
	{
		...
		if(result)
		{
			do 
			{
				...
				it.Name = strdup_local(f[2].GetString());
				it.Description = strdup_local(f[3].GetString());
	...
	/************************************************************************/
	{
		...
		if(result)
		{
			do 
			{
				...
				q.Title = strdup_local(f[2].GetString());
				q.Details = strdup_local(f[3].GetString());
				q.Objectives = strdup_local(f[4].GetString());
				q.CompletionText = strdup_local(f[5].GetString());
				q.IncompleteText = strdup_local(f[6].GetString());
				q.EndText = strdup_local(f[7].GetString());
				q.ObjectiveText[0] = strdup_local(f[8].GetString());
				q.ObjectiveText[1] = strdup_local(f[9].GetString());
				q.ObjectiveText[2] = strdup_local(f[10].GetString());
				q.ObjectiveText[3] = strdup_local(f[11].GetString());
	...
	/************************************************************************/
	{
		...
		if(result)
		{
			do 
			{
				...
				{
					nt.Texts[i][0] = strdup_local(f[counter++].GetString());
					nt.Texts[i][1] = strdup_local(f[counter++].GetString());
				}
	...
	/************************************************************************/
	{
		...
		if(result)
		{
			do 
			{
				...
				nt.Text = strdup_local(f[2].GetString());
